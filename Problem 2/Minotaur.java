...
public class Minotaur {
  ...
  public static void main (String[] args) {
    ...
    while(host.counter < n * 10) {}
    System.out.println("All guests have entered the room 10 times");
    System.out.println("Total times a guest entered the room " + host.counter);
  }
}
